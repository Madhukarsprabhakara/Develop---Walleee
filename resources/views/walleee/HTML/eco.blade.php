...
<a href="http://localhost/walleee/html/#" class="dropdown-toggle" data-toggle="dropdown"> <i
                        class="fa fa-shopping-cart"> </i> <span class="cartRespons"> Cart ($21.00) </span> <b
                        class="caret"> </b> </a>
 -->
...
<div class="grid-description">
 ...
 -->
                   ...
                   <!--  <form method="post" id="pro1">  -->
                            ...
                            <span class="size"><p>$<input  style="width:30px;" class="perdayprice" type="text" id="perdayprice"  value="8"></input> for <input  style="width:30px;" class="nodays" type="text"  id="nodays" value="100"></input> days </p> </span></div>
...
<!--                         {{ csrf_token() }} -->
                        	<div class="action-control"><a id="pro" href="#"  class="btn btn-primary"> <span class="add2cart"><i
