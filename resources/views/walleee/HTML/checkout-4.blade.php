                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li><a href="http://localhost/walleee/html/checkout-1"> <i class="fa fa-map-marker "></i> <span> address</span> </a>
                            </li>
                            ...
                            <li class="active"><a href="http://localhost/walleee/html/checkout-4"><i
                                    class="fa fa-money  "> </i><span>Payment</span> </a></li>
                            <li><a href="http://localhost/walleee/html/checkout-5"><i class="fa fa-check-square "> </i><span>Order</span></a>
                            </li>
                        </ul>
                        <!--orderStep-->
                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading panel-heading-custom">
                                                <h4 class="panel-title"><a class="cashOnDelivery" data-toggle="collapse"
                                                                           data-parent="#accordion" href="http://localhost/walleee/html/#collapseOne">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="pull-right"><a href="http://localhost/walleee/html/checkout-5"
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading panel-heading-custom">
                                                <h4 class="panel-title"><a class="masterCard" data-toggle="collapse"
                                                                           ...
                                                                           href="http://localhost/walleee/html/#collapseThree"> <span
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            <div class="pull-left"><a class="btn btn-default" href="http://localhost/walleee/html/checkout-3"> <i
