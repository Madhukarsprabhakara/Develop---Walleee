...
<head>
    ...
    <link href="http://localhost/walleee/html/assets/css/footable-0.1.css" rel="stylesheet" type="text/css"/>
    <link href="http://localhost/walleee/html/assets/css/footable.sortable-0.1.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="row userInfo">
                ...
                <div class="statusContent">
                    ...
                    <div class="col-sm-6">
                        <div class="order-box">
                            ...
                            <div class="order-box-content">
                                <div class="address">
                                    <p> via Post Air Mail <a title="tracking number" href="http://localhost/walleee/html/#">#4502</a></p>
                                    ...
                                    <table class="order-details-cart">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="http://localhost/walleee/html/product-details"> <img alt="img"
                ...
                <div class="col-lg-12 clearfix">
                    <ul class="pager">
                        ...
                        <li class="next pull-left"><a href="http://localhost/walleee/html/account"> ← Back to My Account</a></li>
                    </ul>
                </div>
            </div>
            <!--/row end-->
