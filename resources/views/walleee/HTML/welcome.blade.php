...
<div class="navbar navbar-tshop navbar-fixed-top megamenu" role="navigation">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand " href="http://localhost"> <img src="images/logo.png" alt="WALLEEE"> </a>
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="http://localhost/walleee/html/category"> Home </a></li>
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-2  col-sm-2 col-md-2  unstyled">
                                ...
                                <li><a href="http://localhost/walleee/html/#"> Punjabi </a></li>
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content ProductDetailsList">
                            ...
                            <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                                ...
                                <li><a href="http://localhost/walleee/html/index-logged-in">Topbar Logged In user menu <span class="label label-success">new</span></a></li>
                        ...
                        <div class="container">
                            <div class="col-lg-12 col-md-12 col-sm-12 sliderTextFull ">
                                <div class="inner text-center">
                                    ...
                                    <a class="btn btn-danger btn-lg bottomAnima animated opacity0">SHOP NOW ON WALLEEE
                        ...
                        <div class="container">
                            <div class="col-lg-12 col-md-12 col-sm-12 sliderTextFull  ">
                                <div class="inner dark maxwidth500 text-center animated topAnima">
                                    ...
                                    <a class="btn btn-danger btn-lg">SHOP NOW ON WALLEEE <span
...
<div class="container main-container">
                ...
                <div class="item itemauto  col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="product">
                        ...
                        <div class="imageHover imageHoverFlip">
                            <a href="http://localhost/walleee/html/product-details"><img src="images/product/7.jpg" alt="img"
    ...
    <div class="width100 section-block ">
        <div class="row featureImg">
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="http://localhost/walleee/html/category"><img src="images/site/new-collection-1.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="http://localhost/walleee/html/category"><img src="images/site/new-collection-2.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="http://localhost/walleee/html/category"><img src="images/site/new-collection-3.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6"><a href="http://localhost/walleee/html/category"><img src="images/site/new-collection-4.jpg"
                                                                                 class="img-responsive" alt="img"></a>
            </div>
        </div>
        <!--/.row-->
