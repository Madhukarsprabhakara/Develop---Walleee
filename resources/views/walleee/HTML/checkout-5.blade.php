                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="w100 clearfix">
                        ...
                        <ul class="orderStep orderStepLook2">
                            <li><a href="http://localhost/walleee/html/checkout-1">
                                <i class="fa fa-map-marker "></i>
                                <span> address</span>
                            </a></li>

                            <li><a href="http://localhost/walleee/html/checkout-2"> <i class="fa fa fa-envelope  "></i>
                                <span> Billing </span></a></li>

                            <li><a href="http://localhost/walleee/html/checkout-3"><i class="fa fa-truck "> </i><span>Shipping</span> </a></li>

                            <li><a href="http://localhost/walleee/html/checkout-4"><i class="fa fa-money  "> </i><span>Payment</span> </a></li>

                            <li class="active"><a href="http://localhost/walleee/html/checkout-5"><i
                        ...
                        <div class="row userInfo">
                            ...
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <td class="CartProductThumb">
                                    <div><a href="http://localhost/walleee/html/product-details"><img src="http://localhost/images/product/fm5.jpg" alt="img"></a>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="price">$1500</td>
                                       ...
                                       <!-- <tr class="CartProduct">
                                            <td class="CartProductThumb">
                                                <div><a href="http://localhost/walleee/html/product-details"><img src="http://localhost/images/product/2.jpg"></a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="CartDescription">
                                                    <h4><a href="http://localhost/walleee/html/product-details">Denim T shirt </a></h4>
                                                    <span class="size">12 x 1.5 L</span>
                                        ...
                                        <tr class="CartProduct">
                                            <td class="CartProductThumb">
                                                <div><a href="http://localhost/walleee/html/product-details"><img src="http://localhost/images/product/5.jpg"></a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="CartDescription">
                                ...
                                <div class="w100 costDetails">
                                    <div class="table-block" id="order-detail-content">
                                        <table class="std table" id="cart-summary">
                                           <tr>
                                    <td>Total Price for 150 days</td>
                                    <td class="price">$1500</td>
                                </tr>
                                <tr style="">
                                    <td>Shipping</td>
                                ...
                                <tr class="cart-total-price ">
                                    <td>Actual Payable (for 150 days.)</td>
                                    <td class="price">$1275.0</td>
                                </tr>
                                <tr>
                                    <td>You save!</td>
                                    <td class="price" id="total-tax">$225.0</td>
                                </tr>
                                            <tbody>
                                            </tbody>
                                        </table>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            <div class="pull-left"><a class="btn btn-default" href="http://localhost/walleee/html/checkout-4">
                                <i class="fa fa-arrow-left"></i> &nbsp; Payment method </a>
                            </div>


                            <div class="pull-right">
                                <a href="http://localhost/walleee/html/thanks-for-order" class="btn btn-primary btn-small ">
            ...
            <div class="w100 cartMiniTable">
                <table id="cart-summary" class="std table">
                    ...
                    <tr>
                                ...
                                <tr>
                                    <td> Billed today</td>
                                    <td class=" site-color" id="total-price">$10</td>
                                </tr>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <div class="pull-right paymentMethodImg">
                ...
                <img height="30" class="pull-right" src="http://localhost/images/site/payment/master_card.png">
                <img height="30" class="pull-right" src="http://localhost/images/site/payment/paypal.png">
                <img height="30" class="pull-right" src="http://localhost/images/site/payment/american_express_card.png">
                <img height="30" class="pull-right" src="http://localhost/images/site/payment/discover_network_card.png">
                <img height="30" class="pull-right" src="http://localhost/images/site/payment/google_wallet.png">
            </div>
