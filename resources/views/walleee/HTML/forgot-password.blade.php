...
<!-- Fixed navbar start -->
<div class="navbar navbar-WALLEEE navbar-fixed-top megamenu" role="navigation">
                        ...
                        <tr class="miniCartProduct">
                            ...
                            <td style="width:40%">
                                <div class="miniCartDescription">
                                    <h4><a href="http://localhost/walleee/html/product-details"> WALLEEE T shirt Black </a></h4>
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content ">
                            <ul class="col-lg-3  col-sm-3 col-md-3 unstyled noMarginLeft newCollectionUl">
                                ...
                                <li><a href="http://localhost/walleee/html/category"> NEW WALLEEE </a></li>
                            </ul>
                    ...
                    <ul class="dropdown-menu">
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-2  col-sm-2 col-md-2  unstyled noMarginLeft">
                                ...
                                <li><a href="http://localhost/walleee/html/#"> WALLEEE </a></li>
                        ...
                        <div class="w100 miniCartTable scroll-pane">
                            <table>
                                ...
                                <tr class="miniCartProduct">
                                    ...
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                            <h4><a href="http://localhost/walleee/html/product-details"> WALLEEE Tshirt DO9 </a></h4>
                                            <span class="size"> 12 x 1.5 L </span>
                                ...
                                <tr class="miniCartProduct">
                                    ...
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                            <h4><a href="http://localhost/walleee/html/product-details"> TShir WALLEEE 09 </a></h4>
                                            <span class="size"> 12 x 1.5 L </span>
                                ...
                                <tr class="miniCartProduct">
                                    ...
                                    <td style="width:40%">
                                        <div class="miniCartDescription">
                                            <h4><a href="http://localhost/walleee/html/product-details"> WALLEEE T shirt DO20 </a></h4>
                                            <span class="size"> 12 x 1.5 L </span>
            ...
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-12">
                    <p> To reset your password, enter the email address you use to sign in to site. We will then send
                        you link to create a new password. </p>
