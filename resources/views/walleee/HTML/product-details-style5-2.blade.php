 ...
 " style="background-color:purple"> </a></li>
                    ...
                    <div class="product-share clearfix">
                        ...
                        <div class="socialIcon">
                            <a href="http://localhost/walleee/html/#"> <i class="fa fa-facebook"></i></a>
                            <a href="http://localhost/walleee/html/#"> <i class="fa fa-twitter"></i></a>
                            <a href="http://localhost/walleee/html/#"> <i class="fa fa-google-plus"></i></a>
                            <a href="http://localhost/walleee/html/#"> <i class="fa fa-pinterest"></i></a></div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <ul class="nav nav-tabs flat list-unstyled list-inline social-inline" role="tablist">
                        <li role="presentation" class="active"><a href="http://localhost/walleee/html/#tab1" aria-controls="home" role="tab"
                                                                  data-toggle="tab">
                            Product details</a></li>
                        <li role="presentation"><a href="http://localhost/walleee/html/#tab2" aria-controls="profile" role="tab" data-toggle="tab">
                            Additional info</a></li>
                        <li role="presentation"><a href="http://localhost/walleee/html/#tab3" aria-controls="messages" role="tab" data-toggle="tab">
                            Fit & Care</a></li>

                        <li role="presentation"><a href="http://localhost/walleee/html/#tab4" aria-controls="settings" role="tab" data-toggle="tab">
                            Product Review</a>
                        </li>
