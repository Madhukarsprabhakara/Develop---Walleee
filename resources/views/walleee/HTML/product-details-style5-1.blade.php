                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-blank ">
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse"
                                                               ...
                                                               href="http://localhost/walleee/html/#collapseOne" aria-expanded="true"
                            ...
                            <div class="panel panel-blank ">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title"><a class="collapsed" role="button" data-toggle="collapse"
                                                               data-parent="#accordion" href="http://localhost/walleee/html/#collapseTwo"
                                                               aria-expanded="false"
    ...
    <div class="product-details-bottom-bar">
        <div class="container-1400 container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="review-title-bar"><a class="scrollto pull-right" href="http://localhost/walleee/html/#product-review"><i
        ...
        <div class="all-review-wrapper wow  fadeIn">
            ...
            <div class="row">
                <div class="col-lg-12 review-load-more">
                    <div class=" text-center"><a href="http://localhost/walleee/html/#" class="btn  btn-default  "> <i class="fa fa-plus-sign">+</i>
            ...
            <div class="row has-equal-height-child">
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner"><a data-placement="left"
                        ...
                        <div class="imageHover hasCart"><a href="http://localhost/walleee/html/product-details"> <img
            ...
            <div class="row">
                ...
                <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-6 col-xxs-12">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled footer-nav">
                            <li><a href="http://localhost/walleee/html/#"> Men's </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Women's</a></li>
                            <li><a href="http://localhost/walleee/html/#"> Kids' </a></li>
                            <li><a href="http://localhost/walleee/html/#">Shoes </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Gift Cards </a></li>
                        </ul>
                    </div>
                </div>
                <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-6 col-xxs-12">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled footer-nav">
                            <li><a href="http://localhost/walleee/html/#">Questions? </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Order Status </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Sizing Charts </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Return Policy </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Contact Us </a></li>
                        </ul>
                    </div>
                </div>
                <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-6 col-xxs-12">
                    <div class="footer-col">
                        ...
                        <ul class="list-unstyled footer-nav">
                            <li><a href="http://localhost/walleee/html/#">Spring/Summer 2015 </a></li>
                            <li><a href="http://localhost/walleee/html/#">Spring/Summer 2014 </a></li>
                            <li><a href="http://localhost/walleee/html/#"> London Fashion Week </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Paris Fashion Week </a></li>
                            <li><a href="http://localhost/walleee/html/#"> Look Back </a></li>
                        </ul>
                    </div>
                </div>
