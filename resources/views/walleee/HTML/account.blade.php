...
<head>
    ...
    <link href="http://localhost/walleee/html/assets/css/ion.checkRadio.css" rel="stylesheet">
    <link href="http://localhost/walleee/html/assets/css/ion.checkRadio.cloudy.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="http://localhost/walleee/html/assets/css/jquery.minimalect.min.css" media="screen"/>
    ...
    <div class="row">
        <div class="breadcrumbDiv col-lg-12">
            <ul class="breadcrumb">
                ...
                <li><a href="http://localhost/walleee/html/account-1">Authentication</a></li>
                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <ul class="myAccountList row">
                        <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                            <div class="thumbnail equalheight"><a title="Orders" href="http://localhost/walleee/html/order-list"><i
                                    class="fa fa-calendar"></i> Order history </a></div>
                        </li>
                        <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                            <div class="thumbnail equalheight"><a title="My addresses" href="http://localhost/walleee/html/my-address"><i
                                    class="fa fa-map-marker"></i> My addresses</a></div>
                        </li>
                        <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                            <div class="thumbnail equalheight"><a title="Add  address" href="http://localhost/walleee/html/add-address"> <i
                                    class="fa fa-edit"> </i> Add address</a></div>
                        </li>
                        <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                            <div class="thumbnail equalheight"><a title="Personal information"
                                                                  href="http://localhost/walleee/html/user-information"><i class="fa fa-cog"></i>
                                Personal information</a></div>
                        </li>
                        <li class="col-lg-2 col-md-2 col-sm-3 col-xs-4  text-center ">
                            <div class="thumbnail equalheight"><a title="My wishlists" href="http://localhost/walleee/html/wishlist"><i
