        ...
        <div class="navbar-cart  collapse">
            <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
                ...
                <div class="miniCartFooter  miniCartFooterInMobile text-right">
                    ...
                    <a href="http://localhost/walleee/html/cart" class="btn btn-sm btn-danger"> <i class="fa fa-shopping-cart"> </i> VIEW CART
                ...
                <div class="dropdown  cartMenu "><a href="http://localhost/walleee/html/#" class="dropdown-toggle" data-toggle="dropdown"> <i
                    ...
                    <div class="dropdown-menu col-lg-4 col-xs-12 col-md-4 ">
                        ...
                        <div class="miniCartFooter text-right">
                            <h3 class="text-right subtotal"> Subtotal: $210 </h3>
                            <a href="http://localhost/walleee/html/cart" class="btn btn-sm btn-danger"> <i class="fa fa-shopping-cart"> </i> VIEW
                                CART </a> <a
                                class="btn btn-sm btn-primary"> CHECKOUT </a></div>
                        <!--/.miniCartFooter-->
...
<div class="container main-container headerOffset">
    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-7 col-xs-6 col-xxs-12 text-center-xs">
            <h1 class="section-title-inner"><span><i
                    class="glyphicon glyphicon-shopping-cart"></i> Savings cart </span></h1>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-5 rightSidebar col-xs-6 col-xxs-12 text-center-xs">
            <h4 class="caps"><a href="http://localhost/category"><i class="fa fa-chevron-left"></i> Back to shopping </a></h4>
        </div>
    </div>
    <!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-7">
			...
			@foreach ($userCartProducts as $cartProducts)
				
                            <tr class="CartProduct">
                                <td class="CartProductThumb">
                         @foreach ($productImage as $productImages)	
									@if ($cartProducts->product_id == $productImages->product_id)       
                                    <div><a href="http://localhost/walleee/html/product-details"><img src="{{$productImages->image}}" alt="img"></a>
                                    @endif
                         @endforeach           
                                    </div>
                                </td>
                                <td>
                                    <div class="CartDescription">
                                        <h4><a href="http://localhost/walleee/html/product-details">{{$cartProducts->product_name}} </a></h4>
                                        <span class="size"><br></span>

                                        <div class="price"><span>${{$cartProducts->amount_per_day}} /day until {{$cartProducts->by_when}}</span></div>
                                    </div>
                                </td>
                                ...
                                <td>0</td>
                                <td class="price">${{$cartProducts->amount}}</td>
                            </tr>
					@endforeach
                            <!--<tr class="CartProduct">
                                <td class="CartProductThumb">
                                    <div><a href="http://localhost/walleee/html/product-details"><img src="http://localhost/images/product/a2.jpg" alt="img"></a>
                                    </div>
                                </td>
                                <td>
                                    <div class="CartDescription">
                            ...
                            <tr class="CartProduct">
                                <td class="CartProductThumb">
                                    <div>
                                        <a href="http://localhost/walleee/html/product-details"><img src="http://localhost/images/product/a5.jpg" alt="img"></a>
                                    </div>
                                </td>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            <div class="pull-left"><a href="http://localhost/category" class="btn btn-default"> <i
            ...
            <div class="contentBox">
                <div class="w100 costDetails">
                    <div class="table-block" id="order-detail-content"><a class="btn btn-primary btn-lg btn-block "
                                                                          title="checkout" href="http://localhost/walleee/html/one-page-checkout"
                        ...
                        <div class="w100 cartMiniTable">
                            <table id="cart-summary" class="std table">
                                <tbody>
                                <tr>
                                    <td> What you would've payed for these products</td>
                                ...
                                <tr class="cart-total-price ">
                                    <td>What you actually pay with WALLEEE savings </td>
                                    <td class="price">${{$totalWithDiscount}}</td>
                                </tr>
                                <tr>
                                    <td>Your reward for saving up!</td>
                                    <td class="price" id="total-tax">${{$discountAmount}}</td>
                                </tr>
                                <tr>
                                    <td> Billed today</td>
                                    <td class=" site-color" id="total-price">${{$totalAmtPDay}}</td>
                                </tr>
                                <tr>
                                    <td colspan="2">
