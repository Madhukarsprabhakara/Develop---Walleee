...
<head>
    ...
    <link href="http://localhost/assets/css/footable-0.1.css" rel="stylesheet" type="text/css"/>
    <link href="http://localhost/assets/css/footable.sortable-0.1.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-cart"><i
                    ...
                    class="cartRespons colorWhite"> Cart ($21.00) </span></button>
        ...
        <div class="navbar-cart  collapse">
            <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
                ...
                <div class="miniCartFooter  miniCartFooterInMobile text-right">
                    <h3 class="text-right subtotal"> Subtotal: $21 </h3>
...
<a data-toggle="dropdown" class="dropdown-toggle" href="http://localhost/walleee/html/#"> New
 ...
 -->
                        ...
                        <li class="megamenu-content ">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                                <li><a class="newProductMenuBlock" href="http://localhost/walleee/html/product-details">
                                    <img class="img-responsive" src="http://localhost/images/site/promo1.jpg" alt="product">
                    ...
                    <i class="fa fa-caret-right"> </i> JEANS </span> </a>
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="http://localhost/walleee/html/product-details">
                                    <img class="img-responsive" src="http://localhost/images/site/promo2.jpg" alt="product">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                                <li><a class="newProductMenuBlock" href="http://localhost/walleee/html/product-details">
                                    <img class="img-responsive" src="http://localhost/images/site/promo3.jpg" alt="product">
...
<a data-toggle="dropdown" class="dropdown-toggle" href="http://localhost/walleee/html/#"> SHOP
                    <b class="caret"> </b> </a>
 -->
                    <ul class="dropdown-menu">
                        <li class="megamenu-content">
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem ">
                                    ...
                                    <a href="http://localhost/walleee/html/product-details">
                                        <img class="img-responsive" src="http://localhost/images/site/g4.jpg" alt="img">
                                    </a>
                            ...
                            <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                                <li class="no-margin productPopItem relative">
                                    <a href="http://localhost/walleee/html/product-details">
                                        <img class="img-responsive" src="http://localhost/images/site/g5.jpg" alt="img">
                                    </a>
                                    <a class="text-center productInfo alpha90" href="http://localhost/walleee/html/product-details"> Eodem modo
                                        typi <br>
                                        <span> $60 </span> </a></li>
                ...
                <li class="dropdown megamenu-fullwidth"><!-- 
<a data-toggle="dropdown" class="dropdown-toggle" href="http://localhost/walleee/html/#">
...
<a href="http://localhost/walleee/html/#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="cartRespons"> Cart ($21.00) </span>
                        <b class="caret"> </b>
                    </a>
 -->
 ...
 -->
    ...
    @if ($flash = session('message'))
        ...
        <div class="col-lg-9 col-md-9 col-sm-7">
            <h1 class="section-title-inner"><span><i class="fa fa-list-alt"></i> People supporting the "Say no to credit card" campaign </span></h1>
            <h3>Without you we would seize to exist </h3>
                    ...
                    <table class="footable">
                        ...
                        <tr>
                            <th data-class="expand" data-sort-initial="true"><span
                                    title="table sorted by this column on load">Supporter</span></th>
                            
                            <th data-hide="default"> No of hours without credit card</th>
                            <th data-hide="default" data-type="numeric"> Date joined</th>
...
<tr>
                            ...
                            <td>Bank Wire</td>
                            <td><a href="http://localhost/walleee/html/order-status" class="btn btn-primary btn-sm">view status</a></td>
<!~~                             <td>$105</td> ~~>
...
<script src="http://localhost/assets/js/footable.js" type="text/javascript"></script>
<script src="http://localhost/assets/js/footable.sortable.js" type="text/javascript"></script>
