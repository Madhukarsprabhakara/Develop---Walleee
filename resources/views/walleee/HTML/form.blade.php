            ...
            <div class=" col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"><a data-toggle="collapse" href="http://localhost/walleee/html/#collapse2" class="collapseWill">
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading">
                        <h4 class="panel-title"><a data-toggle="collapse" href="http://localhost/walleee/html/#collapse1" class="collapseWill"> Input
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li><a href="http://localhost/walleee/html/#">Option one</a></li>
                                                        <li><a href="http://localhost/walleee/html/#">Option two</a></li>
                                                        <li><a href="http://localhost/walleee/html/#">Option three</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading">
                        <h4 class="panel-title"><a data-toggle="collapse" href="http://localhost/walleee/html/#collapse4" class="collapseWill"> Select
                            <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a></h4>
                    </div>
                ...
                <div class="panel panel-default ">
                    <div class="panel-heading">
                        <h4 class="panel-title"><a data-toggle="collapse" href="http://localhost/walleee/html/#collapse5" class="collapseWill"> Button
                            <span class="pull-left"> <i class="fa fa-caret-right"></i></span> </a></h4>
                    </div>
