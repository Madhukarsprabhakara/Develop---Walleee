    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li ><a href="http://localhost/aboutus"> Blog </a></li>
...
$('#sign-up').on('submit',function(e){
    ...
    e.preventDefault(e);
        ...
        success: function(data){
        	...
        	//alert(data);
        	alert("Your profile was successfully created, you will now be redirected to the products page");
        	window.location.replace("http://localhost/productsd_lin");
