    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form   id="loginsubmit" method="post">
                        ...
                        <div class="form-group">
                            <p><a title="Recover your forgotten password" href="http://localhost/walleee/html/forgot-password">Forgot your
                                password? </a></p>
                        </div>
<!--                         <a class="btn btn-primary" href="http://localhost/walleee/html/account"><i class="fa fa-sign-in"></i> Sign In</a> -->
						<button type="submit" value="submit" class="btn   btn-primary"><i class="fa fa-sign-in"></i> Sign In
                        </button>
            ...
            <div class="modal-footer">
                <p class="text-center"> Not here before? <a data-toggle="modal" data-dismiss="modal"
                                                            href="http://localhost/#ModalSignup"> Sign Up. </a> <br>
...
<div class="modal signUpContent fade" id="ModalSignup" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- 
<div class="control-group"><a class="fb_button btn  btn-block btn-lg " onclick="FB.login()" href="FB.login()"> SIGNUP WITH
                    FACEBOOK </a></div>
 -->
<!--                     <div class="fb-login-button" data-max-rows="1" data-size="large" data-button-type="continue_with" data-show-faces="false" data-auto-logout-link="false" data-use-continue-as="false"></div> -->
<!--                 <h5 style="padding:10px 0 10px 0;" class="text-center"> OR </h5> -->
	<form method="post" id="sign-up" autocomplete="off">
                <div class="form-group reg-username">
                    <div>
                    <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        <input id="loginname" name="name" autocomplete="off" class="form-control input" size="80" placeholder="Enter Username"
                               value="" type="text" required>
                    </div>
                </div>
                <div class="form-group reg-email">
                    <div>
                        <input id="loginemail" name="email" autocomplete="off" value="" class="form-control input" size="80" placeholder="Enter Email" type="email" required>
                    </div>
                </div>
                <div class="form-group reg-password">
                    <div>
                    	<input type="hidden" name="mtype_id" value="0" />
                        <input id="loginpassword" autocomplete="off" name="password" value="" class="form-control input" size="20" placeholder="Password"
                ...
                <div class="form-group">
                    <div>
                        <div class="checkbox login-remember">
                            <label>
                                <input name="signup_remember" id="signup_remember" value="1" checked="checked"
                                       type="checkbox">
                                Remember Me </label> 
...
<!--             <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"> </span> -->
				<h3>We are a financially responsible e-commerce platform for planned purchases.</h3>
				 ...
				 <h3>Walleee helps people make most of their money by helping them plan their purchases.<br>
  							 ...
  							 All this without causing financial stress to our consumer by prohibiting use of credit cards on the platform.</h3>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
...
<!--                                 <input type="email" class="full text-center" placeholder="Email "> -->
                               <a href="#" data-toggle="modal" data-target="#ModalSignup"> <button class="btn  bg-gray" type="button"> Signup <i
...
$('#sign-up').on('submit',function(e){
    ...
    e.preventDefault(e);
        ...
        success: function(data){
        	...
        	//alert(data);
        	alert("Your profile was successfully created, you will now be redirected to the category page");
