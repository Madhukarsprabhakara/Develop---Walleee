...
<head>
    ...
    <link href="http://localhost/assets/css/style.css" rel="stylesheet">    <!-- Just for debugging purposes. -->
            ...
            <div class="row userInfo">
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <form role="form" id="sign-up" method="post" class="regForm">
                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" title="Please enter your username (at least 3 characters)" type="text"
                                   class="form-control" placeholder="Enter name" required minlength="3">
                                   <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
                        </div>
                        <div class="form-group">
                            <label>Email address</label>
                            <input name="email" title="Please enter valid email" type="email" class="form-control"
                                   placeholder="Enter email" required>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input required minlength="5"
                                   name="password" title="Please enter your password, between 5 and 12 characters" type="password"
                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <form role="form" method="post" id="loginsubmit" class="logForm ">
                        <div class="form-group">
                            <label>Email address</label>
...
<!--                         <a class="btn btn-primary" href="http://localhost/walleee/html/account"><i class="fa fa-sign-in"></i> Sign In</a> -->
						<button type="submit" class="btn   btn-primary"><i class="fa fa-sign-in"></i> Sign In
                        </button>
...
<script src="http://localhost/assets/js/jquery.validate.js"></script>
