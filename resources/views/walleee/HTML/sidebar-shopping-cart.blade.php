        ...
        <div class=" image-show-case-wrapper center-block relative col-lg-12">
            <div id="imageShowCase" class="owl-carousel owl-theme">
                <div class="product-slide">
                    ...
                    <a href="http://localhost/walleee/html/#"><img class="img-responsive" src="images/slider/single-img/1.jpg" alt="img"></a></div>
                <!-- /.product-slide  -->
                ...
                <div class="product-slide">
                    ...
                    <a href="http://localhost/walleee/html/#"><img class="img-responsive" src="images/slider/single-img/2.jpg" alt="img"></a></div>
                <!-- /.product-slide  -->
                ...
                <div class="product-slide">
                    ...
                    <a href="http://localhost/walleee/html/#"><img class="img-responsive" src="images/slider/single-img/3.jpg" alt="img"></a></div>
                <!-- /.product-slide  -->
            </div>
            <!--/#imageShowCase -->
        ...
        <div class="featuredImageLook3">
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/2.jpg" alt="img"></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/1.jpg" alt="img"></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/3.jpg" alt="img"></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/4.jpg" alt="img"></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/5.jpg" alt="img"></a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
                <div class="inner">
                    ...
                    <a class="img-block" href="http://localhost/walleee/html/#"> <img class="img-responsive" src="images/look3/6.jpg" alt="img"></a>
                </div>
            </div>
        </div>
        <!--/.featuredImageLook3-->
    ...
    <div class="width100 section-block  text-center">
        <div class="row featuredImgLook2">
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="inner" style="height: 414px;"><a href="http://localhost/walleee/html/category" class="img-link"><img alt="img"
                    ...
                    <a class="btn btn-link" href="http://localhost/walleee/html/blog-details"> See More <i class="fa fa-long-arrow-right"></i>
                    </a></div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="inner" style="height: 414px;"><a href="http://localhost/walleee/html/category" class="img-link"><img alt="img"
