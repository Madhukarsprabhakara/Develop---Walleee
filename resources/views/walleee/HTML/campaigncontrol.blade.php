    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<form role="form" id="sign-up" method="post" class="regForm">
                <div class="form-group reg-username">
                    <div>
                        <input name="name" class="form-control input" size="20" placeholder="Enter Username"
                               type="text" required>
                ...
                <div class="form-group reg-email">
                    <div>
                        <input name="email" class="form-control input" size="20" placeholder="Enter Email" type="text" required>
                    </div>
                </div>
...
<!--             <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"> </span> -->
				<h3>Thanks a lot for checking us out and for supporting us in this endevour of making this world a better place for one and all.</h3>
			
			
				
				 <h3>If you do not want to be associated with our campaign, it is ok and we totally underatand that you have your reasons.<br>
  			
  					
  					
  							 Just click on stop to stop supporting us on the campaign or   <a href="http://localhost/ourpillars" class="text-warning"> click here </a>to see whos supporting us.</h3>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-8">
		...
		<div class="col-lg-4 col-md-4 col-sm-4">
			...
			<a href="http://localhost/ourpillars/start" ><button class="btn  bg-gray disabled" type="button" disabled> Start <i
...
<!--                                 <input type="email" class="full text-center" placeholder="Email "> -->
                               <a href="http://localhost/ourpillars/stop"> <button class="btn  bg-gray" type="button"> Stop <i
                                        class="fa fa-long-arrow-right"> </i></button></a>
		...
		<div class="col-lg-4 col-md-4 col-sm-4">
			<div class="col-centered input-append newsLatterBox text-center">
			<a href="http://localhost/ourpillars/start" ><button class="btn  bg-gray" type="button" > Start <i
                                        class="fa fa-long-arrow-right"> </i></button></a>
            </div>
		</div>
		<div></div>
		<div class="col-lg-4 col-md-4 col-sm-4">
			<div class="col-centered input-append newsLatterBox text-center">
<!--                                 <input type="email" class="full text-center" placeholder="Email "> -->
                               <a href="http://localhost/ourpillars/stop"> <button class="btn  bg-gray " type="button"  disabled> Stop <i
                                        class="fa fa-long-arrow-right"> </i></button></a>
...
$('#sign-up').on('submit',function(e){
    ...
    e.preventDefault(e);
        ...
        success: function(data){
        	...
        	//alert(data);
        	alert("Your profile was created successfully, you will now be redirected to products page");
        	window.location = "http://localhost/productsd_lin";
