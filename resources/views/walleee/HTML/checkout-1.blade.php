                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li class="active"><a href="http://localhost/walleee/html/checkout-1"> <i class="fa fa-map-marker "></i> <span> address</span>
                            </a></li>
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            <div class="pull-left"><a class="btn btn-default" href="http://localhost/walleee/html/index"> <i
                                    class="fa fa-arrow-left"></i> &nbsp; Back to Shop </a></div>
                            <div class="pull-right"><a class="btn btn-primary btn-small " href="http://localhost/walleee/html/checkout-2">
