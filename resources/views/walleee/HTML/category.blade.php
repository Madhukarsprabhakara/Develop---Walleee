                ...
                <div class="form-group">
                    <div>
                        <div class="checkbox login-remember">
                            <label>
                                <input name="signin_remember" id="signin_remember" value="1" checked="checked" type="checkbox">
                                Remember Me </label>
                        </div>
                    </div>
                </div>
...
<li class="active dropdown-tree open-tree"><a class="dropdown-tree-a"> <span
                                        class="badge pull-right"></span> Electronics  </a>
                                    <ul class="category-level-2 dropdown-menu-tree">
                                    	<li class="dropdown-tree"><a class="dropdown-tree-a" href="http://localhost/walleee/html/eco">
                                            Televisions</a></li>
