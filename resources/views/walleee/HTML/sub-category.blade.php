    ...
    <div class="row">
                            ...
                            <ul class="nav nav-pills nav-stacked tree">
                                <li class="active dropdown-tree open-tree"><a class="dropdown-tree-a"> <span
                                    ...
                                    <ul class="category-level-2 dropdown-menu-tree">
                                        <li class="dropdown-tree open-tree"><a class="dropdown-tree-a" href="http://localhost/walleee/html/#">
                                            Tshirt</a>
                                            <ul class="category-level-2 dropdown-menu-tree">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12">
            ...
            <div class="w100 clearfix category-top">
                ...
                <div class="categoryImage"><img src="http://localhost/images/site/meditation.png" class="img-responsive" alt="img">
                </div>
            </div>
            <!--/.category-top-->
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="http://localhost/walleee/html/product-details"><img class="img-responsive" alt="img"
                                                                src="http://localhost/images/product/fm5.jpg"></a>
...
<div class="grid-description">
 ...
 -->
                           ...
                           <!-- <div class="list-description">
                            ...
                            <div class="price" id="firstProduct">$<span id="totalprice">1500</span></div><br>
                            <span class="size"><p>$<input  style="width:30px;" type="text" id="perdayprice"  placeholder="10"></input> for <input  style="width:30px;" type="text"  id="nodays" placeholder="150"></input> days </p> </span></div>
<!--                             <p>$<input  style="width:30px;height:20px;margin:2px;padding:0px" type="text" id="perdayprice" placeholder="10"></input> for <input  style="width:30px;height:20px;margin:2px;padding:0px" type="text" id="nodays" placeholder="150"></input> days </p> -->
                        ...
                        <div class="action-control"><a href="http://localhost/walleee/html/cart" class="btn btn-primary"> <span class="add2cart"><i
...
<script>
    ...
    $('#perdayprice').keyup(function(){
    	...
    	var newPerDayPrice = $('#perdayprice').val();
    	//console.log('new price per day' +newPerDayPrice );
    	var totalPrice = $('#firstProduct span').text();
