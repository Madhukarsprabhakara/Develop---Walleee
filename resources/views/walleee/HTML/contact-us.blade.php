      ...
      <div class="row">
        <div class="col-lg-3  col-md-3 col-sm-4 col-xs-6">
          ...
          <ul>
            <li class="supportLi">
              ...
              <h4> <a class="inline" href="http://localhost/walleee/html/mailto:help@yourweb.com"> <i class="fa fa-envelope-o"> </i> help@yourweb.com </a> </h4>
            </li>
          </ul>
        </div>
        ...
        <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
          ...
          <ul>
            ...
            <li> <a href="http://localhost/walleee/html/about-us-2"> About us 2 </a> </li>
            <li> <a href="http://localhost/walleee/html/contact-us"> Contact us </a> </li>
            <li> <a href="http://localhost/walleee/html/contact-us-2"> Contact us 2 </a> </li>
            <li> <a href="http://localhost/walleee/html/terms-conditions"> Terms &amp; Conditions </a> </li>
          </ul>
        </div>
        <div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
    ...
    <div class="container">
        ...
        <div class="pull-right paymentMethodImg"><img height="30" class="pull-right"
                ...
                height="30" class="pull-right" src="http://localhost/images/site/payment/visa_card.png" alt="img"><img height="30"
                                                                                                      ...
                                                                                                      alt="img"> <img
                height="30" class="pull-right" src="http://localhost/images/site/payment/american_express_card.png" alt="img"> <img
                height="30" class="pull-right" src="http://localhost/images/site/payment/discover_network_card.png" alt="img"> <img
                height="30" class="pull-right" src="http://localhost/images/site/payment/google_wallet.png" alt="img">
