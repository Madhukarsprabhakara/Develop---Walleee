                ...
                <div class="product-images-carousel-wrapper">
                    ...
                    <div class="productMainImage hasWhiteImg">
                        <ul class="bxslider product-view-slides product-view-slides-h ">
                            <li><img src="http://localhost/images/product_details/low-res-white/1.jpg" alt="img"/></li>
                            <li><img src="http://localhost/images/product_details/low-res-white/2.jpg" alt="img"/></li>
                            <li><img src="http://localhost/images/product_details/low-res-white/3.jpg" alt="img"/></li>
                    ...
                    <div class="product-view-thumb-wrapper has-carousel-v hasWhiteImg">
                        ...
                        <ul id="bx-pager" class="product-view-thumb ">
                            <li><a class="thumb-item-link" data-slide-index="0" href="http://localhost/walleee/html/"><img
                                    src="http://localhost/images/product_details/low-res-white/1.jpg" alt="img"/></a></li>
                            <li><a class="thumb-item-link" data-slide-index="1" href="http://localhost/walleee/html/"><img
                                    src="http://localhost/images/product_details/low-res-white/2.jpg" alt="img"/></a></li>
                            <li><a class="thumb-item-link" data-slide-index="2" href="http://localhost/walleee/html/"><img
                                    src="http://localhost/images/product_details/low-res-white/3.jpg" alt="img"/></a></li>
                            <li><a class="popup-vimeo" href="http://localhost/walleee/html/https://player.vimeo.com/video/95929658"><img
                                    src="http://localhost/images/product_details/low-res-white/video-thumb.jpg" alt="img"/></a></li>
                        </ul>
            ...
            <div class="row has-equal-height-child">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                    <div class="product-story-a-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.25">
                        <img alt="Image Title" src="http://localhost/images/product_details/product-features.jpg"
    ...
    <div class="product-story-inner ">
        ...
        <div class="container">
            ...
            <div class="row has-equal-height-child">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  is-equal">
                    <div class="product-story-a-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.25">
                        <img alt="Image Title" src="http://localhost/images/product_details/size-guide-model.jpg"
                             class="img-responsive ">
                    </div>
                </div>
        ...
        <div class="all-review-wrapper wow  fadeIn">
                ...
                <div class="col-lg-3 col-sm-3  left">
                    <div class="review-item-user">
                        <div class="review-item-user-profile">
                            <img class="img-circle" alt="" src="http://localhost/images/product_details/user-2.jpg">
                        </div>
                        <div class="user-name">
                            <p>John Doe </p>
                            <small>5m ago</small>
            ...
            <div class="row review-item">
                <div class="col-lg-3 col-sm-3  left">
                    <div class="review-item-user">
                        <div class="review-item-user-profile">
                            <img class="img-circle" alt="" src="http://localhost/images/site/default-user.png">
                        </div>
                        <div class="user-name">
                            <p>John Doe </p>
                            <small>5m ago</small>
            ...
            <div class="row has-equal-height-child">
                    ...
                    <div class="product product-item-inner">
                        ...
                        <div class="imageHover hasCart">
                            <a href="http://localhost/walleee/html/product-details">
                                <img class="img-responsive primaryImage" alt="img" src="http://localhost/images/product/54a.jpg">
                                <img class="img-responsive secondaryImage" alt="img" src="http://localhost/images/product/54b.jpg"></a>
                ...
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner">
                        ...
                        <div class="imageHover hasCart">
                            <a href="http://localhost/walleee/html/product-details">
                                <img class="img-responsive primaryImage" alt="img" src="http://localhost/images/product/53a.jpg">
                                <img class="img-responsive secondaryImage" alt="img" src="http://localhost/images/product/53b.jpg"></a>
                ...
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner">
                        ...
                        <div class="imageHover hasCart">
                            <a href="http://localhost/walleee/html/product-details">
                                <img class="img-responsive primaryImage" alt="img" src="http://localhost/images/product/50a.jpg">
                                <img class="img-responsive secondaryImage" alt="img" src="http://localhost/images/product/50b.jpg"></a>
                ...
                <div class="product-item item-flat col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12">
                    <div class="product product-item-inner">
                        ...
                        <div class="imageHover hasCart">
                            <a href="http://localhost/walleee/html/product-details">
                                <img class="img-responsive primaryImage" alt="img" src="http://localhost/images/product/51a.jpg">
                                <img class="img-responsive secondaryImage" alt="img" src="http://localhost/images/product/51b.jpg"></a>
			...
			<span class="input-group-btn">
                ...
                <div class="col-lg-12">
                    <div class=" text-center paymanet-method-logo">
                        ...
                        <img src="http://localhost/images/site/payment/master_card.png" alt="img">
                        <img alt="img" src="http://localhost/images/site/payment/visa_card.png">
                        <img alt="img" src="http://localhost/images/site/payment/paypal.png">
                        <img alt="img" src="http://localhost/images/site/payment/american_express_card.png"> <img alt="img"
                                                                                                 src="http://localhost/images/site/payment/discover_network_card.png">
                        <img alt="img" src="http://localhost/images/site/payment/google_wallet.png">
                    </div>
...
<script src="http://localhost/assets/plugins/magnific/jquery.magnific-popup.min.js"></script>
<script>
...
<script src="http://localhost/assets/plugins/bxslider/plugins/jquery.fitvids.js"></script>
<script src="http://localhost/assets/plugins/bxslider/jquery.bxslider.min.js"></script>
...
<script type="text/javascript" src="http://localhost/assets/js/skrollr.min.js"></script>
